 ...
 */
#define LOG_TAG "vendor.sprd.hardware.boot@1.1-impl"
...
Return<bool> BootControl::SetSpldestroyBeforeSetactiveFlag(bool flag) {
    struct CommandResult cr;
    return impl_.SetSpldestroyBeforeSetactiveFlag(flag);
}
