...
# This target has A/B partition scheme
AB_OTA_UPDATER := true
...
# SUPER (A/B Dynamic Partitions Cluster)
BOARD_SUPER_PARTITION_SIZE := 5452595200
BOARD_SUPER_PARTITION_GROUPS := motorola_dynamic_partitions
BOARD_MOTOROLA_DYNAMIC_PARTITIONS_PARTITION_LIST := system system_ext vendor product vendor
BOARD_MOTOROLA_DYNAMIC_PARTITIONS_SIZE := 2726297600 # (BOARD_SUPER_PARTITION_SIZE) / 2
